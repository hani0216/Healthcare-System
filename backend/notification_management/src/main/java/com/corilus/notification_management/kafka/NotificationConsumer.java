...
public class NotificationConsumer {
    ...
    public void listenForDocumentCreated(String message) {
        try {
            ...
            notificationDto.setTitle("DOCUMENT " + eventType);
            notificationDto.setMessage("Document " + eventType + " named: " + title);
