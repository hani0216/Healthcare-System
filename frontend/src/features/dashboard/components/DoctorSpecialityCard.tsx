...
const DoctorSpecialityCard: React.FC<DoctorSpecialityCardProps> = ({ name, desc, onClick }) => {
  return (
    <div className="card-hover-effect" style={{ height:'370px' , width:'300px' , borderRadius:'20px'}}>
<div  style={{ background: 'linear-gradient(135deg, #f0f9ff 0%, #e0f2fe 50%, #bae6fd 100%)'  }}>
  ...
  alignItems: 'center' , borderRadius:'50%'}}>
                          <FaBrain className="text-2xl"  style={{backgroundColor:'#22c55e'  , borderRadius:'20%' , width:'50px' , height:"50px" , margin:'20px'}}/>
